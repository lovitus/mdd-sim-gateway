...
final class SmsGatewayFixture implements AutoCloseable {
    ...
    SmsGatewayFixture(Context context,String mode)throws Exception{
        assertTrue(context.getPackageName().endsWith(".qa"));this.mode=mode;store=new ConfigStore(context);
