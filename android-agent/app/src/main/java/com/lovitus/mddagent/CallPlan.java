...
final class CallPlan {
    ...
    CallPlan(JSONObject saved)throws Exception{
        ...
        endOperation=saved.getString("end_operation_id");incoming=saved.optJSONObject("incoming");
    ...
    JSONObject record(){return Json.obj("line",line,"card",card,"mode",mode,"number",number,"call_id",id,
        "operation_id",operation,"end_operation_id",endOperation,"incoming",incoming==null?JSONObject.NULL:incoming);}
