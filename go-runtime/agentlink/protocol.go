...
func (message envelope) validate() error {
	switch message.Kind {
	case kindHello:
		if message.RequestID != "" || message.Hello == nil || message.AKARequest != nil || message.AKAResult != nil || message.ModemRequest != nil || message.ModemResult != nil || message.MediaRequest != nil || message.MediaResult != nil || !message.emptyEUICC() || !message.emptyDownload() || message.Health != nil {
	...
	case kindHelloAck:
		...
		return nil
	case kindAKARequest:
		if !validIdentifier(message.RequestID) || message.Hello != nil || message.AKARequest == nil || message.AKAResult != nil || message.ModemRequest != nil || message.ModemResult != nil || message.MediaRequest != nil || message.MediaResult != nil || !message.emptyEUICC() || !message.emptyDownload() || message.Health != nil {
	...
	case kindEUICCRequest:
		if !validIdentifier(message.RequestID) || message.Hello != nil || message.AKARequest != nil || message.AKAResult != nil || message.ModemRequest != nil || message.ModemResult != nil || message.MediaRequest != nil || message.MediaResult != nil || message.EUICCRequest == nil || message.EUICCResult != nil || !message.emptyDownload() || message.Health != nil {
	...
	case kindDownloadRequest:
		if !validIdentifier(message.RequestID) || message.Hello != nil || message.AKARequest != nil || message.AKAResult != nil || message.ModemRequest != nil || message.ModemResult != nil || message.MediaRequest != nil || message.MediaResult != nil || !message.emptyEUICC() || message.DownloadRequest == nil || message.DownloadResult != nil || message.Health != nil {
