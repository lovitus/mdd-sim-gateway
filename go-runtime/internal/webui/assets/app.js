...
const VIEWS=Object.freeze({
  overview:{title:"概览",subtitle:"查看线路、Agent 与硬件的权威实时事实。"},
...
function render(snapshot){
  ...
  renderLines(catalog,lines);renderAgents(agents);renderCallLines(catalog);renderMessageLines(catalog);renderMessages(Array.isArray(snapshot.messages)?snapshot.messages:[]);restorePendingMessage();refreshCallStatuses();if(state.view==="settings")loadLineCandidates();
}
