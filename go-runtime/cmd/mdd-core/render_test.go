...
func TestRenderProviderDirectoryIsDeterministicAndUsesDynamicIPC(t *testing.T) {
	...
	snapshot := linecatalog.Snapshot{SchemaVersion: 1, Revision: 7, Defaults: linecatalog.ProviderDefaults{RekeyMinutes: 30, IKERekeyMinutes: 600}, Lines: []linecatalog.Line{line, disabled}}
	...
	if provider.IPC.Listen != "127.0.0.1:0" || provider.Core.RegistrationURL != "http://127.0.0.1:39002/v1/media/providers" ||
		...
		provider.Network.RekeyMinutes != 30 || provider.Network.IKERekeyMinutes != 600 ||
