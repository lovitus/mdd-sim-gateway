...
phase: E4_CANDIDATE_CREATED_METADATA_INHERITANCE_ATTESTATION_CONTINUATION
deployment_cursor: 原96e core已执行；新record1345/control-cutover phase manual_required/failed_phase candidate_created。旧c96仍running，源码仍858未切；候选8275e7855a395e5bc9f2dfb203abe46b32faff9bd8f253d3988f862e532bece8仅created，合法Engine manifest engine-replace-1787723466-02b410ca360f prepared仍在。禁止重跑execute、另建candidate或清manifest。唯一差异由父/预审双重实证为Docker继承image Label org.opencontainers.image.revision=fb4，其余Config/HostConfig全等；正在原核心不变的本次exact-created续接中仅将该匹配metadata加入内存读回预期。exactplan d34e1e3d2e2e37edc5ca233e1131a77094f4d7aa20f33f41fb59cb4b6e9003f9 已上传root0600，原失败/rawdiff保留private mdd-e4-release-incoming。续接脚本及独立复审在private mdd-e4-control-pre-review-fb4bce5，拿到后才执行，仍需原wrapper+finalize+postflight。
