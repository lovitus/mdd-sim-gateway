...
export const api = {
  ...
  checkUpdate: (force = false) => j('GET', '/v1/system/update/check' + (force ? '?force=true' : ''), undefined, {}, 75000),
  applyUpdate: expectedTarget => j('POST', '/v1/system/update/apply', { expected_target: expectedTarget }, {}, 75000),
...
Object.assign(api, {
  ...
  webSettings: () => j('GET','/v1/system/web'),
	 hostModemSettings:()=>j('GET','/v1/system/host-modem'),
	 saveHostModemSettings:input=>j('PUT','/v1/system/host-modem',input,{},305000),
  ...
  adminAudit: () => j('GET', '/v1/system/audit'),
  systemStatus: async () => {
